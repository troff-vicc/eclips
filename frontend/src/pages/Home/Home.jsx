  ...
  const featureBlocks = [
    {
      id: 1,
      image: './f1.jpeg',
      text: 'Учёными Воронежского государственного университета успешно реализован научный проект по изучению состояния городских экосистем',
      title: 'Качественное образование'
    },
    {
      id: 2,
      image: './f2.jpeg',
      text: 'Диалог науки и религии: не конфликт, а мир и сотрудничество',
      title: 'Современные лаборатории'
    },
    {
      id: 3,
      image: './f3.jpeg',
      text: 'В ВГУ обсудили духовные вызовы и национальную безопасность на молодёжной конференции',
      title: 'Международное сотрудничество'
    },
    {
      id: 4,
      image: './f4.jpeg',
      text: 'Коллектив Института международного образования ВГУ повысил квалификацию',
